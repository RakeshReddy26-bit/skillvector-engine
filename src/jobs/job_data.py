"""
Static job posting data for SkillVector Engine.

Used by both the Pinecone seeder (local) and RAG retriever (production).
No heavy dependencies — safe to import on memory-constrained servers.
"""
